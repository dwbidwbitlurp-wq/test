...
export const LESSONS = [
  ...
  { id: 'crime', title: 'Закон королевства', keys: [['Удар по жителю', 'преступление']], text: 'Можно ударить мирного жителя — он в страхе убежит и позовёт стражу. Если нападение увидит рыцарь или стражник, стража атакует вас, пока вы не отойдёте подальше или не заплатите штраф у капитана Роланда.' },
];
