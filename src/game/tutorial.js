...
export const LESSONS = [
  ...
  { id: 'vitals', title: 'Полоски слева вверху', keys: [['Розовая', 'здоровье'], ['Зелёная', 'выносливость'], ['Синяя', 'мана'], ['Жёлтая', 'сытость']], text: 'Выносливость тратится на удары, блок, перекаты, прыжки и бег и сама восстанавливается за пару секунд. Если она кончилась, полоска рыжеет — отступите. Мана нужна для заклинаний. Сытость убывает со временем: сытого (выше 60%) вне боя понемногу лечит, а на нуле выносливость восстанавливается на 40% медленнее — поешьте. Кружок с цифрой — ваш уровень.' },
  ...
  { id: 'glimmer', title: 'Сияние и уровень', keys: [['Алтарь → E', 'повысить уровень'], ['K', 'древо навыков']], text: 'За победы, книги и задания вы получаете сияние (ромбик справа внизу). Уровень не растёт сам: у алтаря обменяйте сияние на уровень и поднимите характеристики, а за каждый уровень получите очко навыка для древа (K). Если падёте, сияние останется на месте гибели (лиловая метка на карте), а часть золота пропадёт.' },
  ...
  { id: 'theft', title: 'Чужое', keys: [['Красная подсказка', 'кража'], ['«никто не видит»', 'можно брать']], text: 'Вещи хозяев подсвечены красным, а подсказка говорит, видит ли вас кто-нибудь. Кражу замечают, только если смотрят в вашу сторону и между вами нет стен: спереди — до 10 м (стражник — 13 м), краем глаза — втрое ближе, ночью на улице — почти вдвое ближе. За спиной слышат лишь вплотную: 2 м, если стоять тихо, и до 6 м на бегу. Поймают — штраф, вещь останется у хозяина.' },
  ...
  { id: 'crime', title: 'Закон королевства', keys: [['Удар по жителю', 'преступление']], text: 'Можно ударить мирного жителя — он в страхе убежит и позовёт стражу. Если нападение увидит (или услышит крик в 12 м) рыцарь или стражник, стража атакует вас, пока вы не отойдёте подальше или не заплатите штраф у капитана Роланда.' },
];
...
export class Tutorial {
  ...
  update(dt) {
    ...
    if (t > 14 && this.seen().includes('move')) this.show('vitals');
